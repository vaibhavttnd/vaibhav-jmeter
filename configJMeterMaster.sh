#!/bin/bash
PROJECT=loadtestingdemo_krishna_wtctd;BUCKET_INSTALL=LoadTesting_loadtestingdemo_krishna_wtctd;BUCKET_RESULT=LoadTestingResults_loadtestingdemo_krishna_wtctd;
