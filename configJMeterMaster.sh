#!/bin/bash
PROJECT=loadtesting_demo_ZTpGWRbAOY;BUCKET_INSTALL=LoadTesting_loadtesting_demo_ZTpGWRbAOY;BUCKET_RESULT=LoadTestingResults_loadtesting_demo_ZTpGWRbAOY;
