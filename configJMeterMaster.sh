#!/bin/bash
PROJECT=betatothenew_loadtest_qhirselnff;BUCKET_INSTALL=LoadTesting_betatothenew_loadtest_qhirselnff;BUCKET_RESULT=LoadTestingResults_betatothenew_loadtest_qhirselnff;
